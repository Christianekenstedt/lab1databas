...
/**
 * ConnectionToDB contains the methods used to connect to the database and
 * methods to make SQL querys
 *
...
public class ConnectionToDb implements DBCommunication {
     ...
     * @param artist, of the album you want to add(will check if artist is
    ...
    public void addAlbum(String title, String artist, String nationality, Date date, Genre genre, Grade grade) throws SQLException {
        ...
        try {
            ...
            addAlbumPrepSt.setString(1, title);
            addAlbumPrepSt.setDate(2, date);
            addAlbumPrepSt.setInt(3, genre.getGenreID());
            addAlbumPrepSt.setInt(4, grade.getGradeID());
            ...
            if (rsAlbumID.next()) {
                ...
                if (!rs.next()) {
                    addArtistPrepSt.setString(1, artist);
                    addArtistPrepSt.setString(2, nationality);
